    ...
    return (
        <header class="cabecalho container">
			...
			<nav>
				<ul class="cabecalho__menu">
					<li class="cabecalho__item-menu"><a href="sobre.php#contato"> Contato </a></li>
					<li class="cabecalho__item-menu"><a href="#"> Entrar </a></li>
					<li class="cabecalho__item-menu cabecalho__item-menu--matricular"><a href="#"> Cadastrar-se </a></li>
				</ul>
			</nav>
		...
		<main>
			...
			<section class="video">
				...
				<video controls class="video--desktop" src="video/video-promocional.mp4" poster="img/video-principal2.png"></video>
			...
			<section class="beneficios">
				...
				<ul class="beneficios__lista">
					...
					<li class="beneficio--online">
						...
						<p class="beneficio__texto">Aprender em DVD e revistinha de banca são coisas do passado! 
			...
			<section class="chamada__youtube">
				<article class="chamada__youtube__canal youtube__informacao icone--youtube --largura-grande">
					...
					ia Musical e mais!</p>
					<a href="https://www.youtube.com/user/musicdotonline" class="canal__button botao">VerCanal</a>
				</article>
				<article class="chamada__youtube__canal chamada__youtube--video1">
					<a class="video__descricao" href="#">
						...
						<p class="descricao__texto">Nessa aula a professora Anny Cee dá as primeiras dicas 
			...
			<section class="chamada__aplicativo">
				...
				ar offline e fazer os exercícios. Disponível para Android e iOS. Já é aluno? <strong class="textodestaque">
				Baixe já:</strong></p>
				<a href="https://play.google.com/store/apps/details?id=br.com.musicdot&hl=en" 
				class="aplicativo__button app__download--android botao">Android</a>
				<a href="https://apps.apple.com/br/app/musicdot/id1333842849" 
				class="aplicativo__button app__download--ios botao">iOS</a>
			</section>
